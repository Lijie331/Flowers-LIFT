...
class RN_Tuner(nn.Module):
    ...
    def __init__(self, cfg, rn_model, num_classes):
        ...
        if isinstance(rn_model, CLIP_RN):
            ...
            raise TypeError(f"Unsupported rn_model type: {type(rn_model)}")
